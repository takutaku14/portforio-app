...
const portfolioData = {
  ...
  works: [
    // --- id: 1 のオブジェクト全体を差し替え ---
    {
      id: 1,
      category: "長期インターンシップ",
      title: "事例1：社内業務を50倍効率化した画像処理プラットフォーム", // ESの見出しと統一
    ...
    // --- id: 5 (研究) のオブジェクト全体を差し替え ---
    {
      id: 5,
      category: "研究",
      title: "事例3：アイトラッキングを用いたVR眼精疲労のリアルタイム予測システム", // ESに合わせる
      thumbnail: `https://placehold.co/600x400/FCA5A5/FFFFFF?text=VR+Research`,
      description: "VR利用時の眼精疲労を客観的指標（視線データ）と機械学習でリアルタイム予測。精度85%を達成し、安全性向上に貢献。", // ESに合わせる
      tags: ["AI", "機械学習", "データ分析", "Python", "VR/AR", "研究開発", "HCI"], // tags を更新
      overview: "VR市場拡大の障壁である眼精疲労に対し、従来の主観評価の限界（客観性・リアルタイム性欠如）を解決するため、アイトラッキング技術を用いた定量的な疲労予測システムを開発。視線データから疲労度を自動予測し、「疲れる前に休憩を促す」などVR体験の安全性と快適性向上を目指す研究です。", // ESに合わせる
      siteUrl: null,
      repoUrl: null,
      screenshots: [],
      stack: {
      ...
      points: [
        ...
        "学術的貢献への意欲：本研究成果は現在、指導教員と相談の上、ヒューマンコンピュータインタラクション分野の国際会議への論文投稿準備を進めています。", // ESの成果を反映
    ...
    // --- id: 8 (VRゲーム) のオブジェクト全体を差し替え ---
    {
      ...
      description: "UnityとXR Interaction Toolkitを用い、3人チームで開発したVR脱出ゲーム。大学オープンキャンパスで展示し、没入型体験を提供。", // ESに合わせる
      tags: ["VR", "Unity", "C#", "XR Interaction Toolkit", "Meta Quest", "チーム開発", "学内展示", "UXデザイン"], // tags を更新
      overview: "オープンキャンパス来場者、特にVR未経験者にVR技術の可能性と「没入型体験」の楽しさを伝える目的で、3人チームで開発した脱出ゲームです。私は主にビジュアル（UIデザイン、3Dモデル配置・調整）を担当。Meta Quest向けにXR Interaction Toolkitを活用し、コントローラーでの直感的な操作を通じて謎解きを進める、短いながらも 몰입감 있는 (몰입감 있는) 体験を提供しました。", // ESに合わせて微修正
      siteUrl: null,
      ...
      points: [
        ...
        "VR未経験者への配慮と没入体験の提供：XR Interaction Toolkitを用いた直感的な操作とシンプルなルールで、初めてVRに触れる方でも楽しめる「没入型体験」の提供を目指しました。", // 没入体験を追記
        "オープンキャンパスでの実践と学び：多くの来場者への展示を通じて、難易度調整の重要性や視点高さの個人差など、より良いVR体験デザインのための実践的な知見を得ました。", // 表現を調整
        "VR酔いへの課題認識：想定以上にVR酔いを訴える方が多く（約7割）、移動方法や描画設定など、快適なVR体験を提供するための技術的な課題と向き合う貴重な機会となりました。",
