...
const portfolioData = {
  ...
  social: {
    github: "https://github.com/takutaku14",
    email: "mailto:your-email@example.com"
  },
  about: {
    summary: "大学院での研究と長期インターンでのPM経験を通じて培った、「表面的な課題ではなく、本質を見抜く力」を武器に、隠れた需要を発掘し新しいビジネス価値を創出するエンジニアです。長期インターンでは、標本調査により「外部情報の調査」という隠れたニーズを発見し、「社内業務に特化したAIパートナー」という独自解を創出。年間コスト70%削減を実現しました。研究では、VR眼精疲労予測の壁を、専門外のHCIを独学で習得し視線制御へのピボットで突破。精度85%を達成しました。",
    introduction: "私の原動力は、「表面的な課題ではなく、本質を見抜く力」です。大学院での視線解析の研究では、瞳孔計測の精度限界に直面した際、表面的な解決策（精度向上）ではなく本質的な原因（視線制御の劣化）に着目。専門外のHCIを独学で習得し、アプローチを転換して精度85%を達成しました。長期インターンでは、標本調査により「外部情報の調査」という隠れたニーズを発掘し、独自解の創出でコスト70%削減を実現しました。異なる分野でも、データに基づく仮説検証と論理的な戦略立てで本質を見抜き、確実に結果を出す「没頭力」と「緻密な計画性」を持ちます。",
    story: [
      {
    ...
    values: [
      {
        ...
        description: "長期インターンでは、標本調査により経営層も現場も気づいていなかった「外部情報の調査」という隠れたニーズを発見。「社内業務に特化したAIパートナー」という独自解を創出しました。研究でも、瞳孔計測という表面的な手法ではなく、視線制御という本質に着目してブレークスルーを達成。異なる分野でも、表面的な課題ではなく本質を見抜く力で、新しい価値を創造します。"
      },
      {
