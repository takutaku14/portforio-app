  ...
  works: [
    {
      ...
      team: "3名",
      duration: "6ヶ月",
      focusPoint: "「コスト70%削減」と「現場満足度」の両立。経営層の反対をデータで説得したプロセスと、3段階リリースによる品質向上が評価された点。",
      overview: "「ChatGPT Enterprise版（年間約2,000万円）のランニングコストが重荷になっている」という経営課題に対し、完全内製化によるリプレイスを提案。当初、経営層からは「Web検索機能は不要」と反対されましたが、現場アンケートで「競合調査ニーズ」をデータで証明し、機能を実装。PMとして「経営（コスト）」と「現場（実用性）」の利害を調整しつつ、α版→β版→本番という3段階リリースで品質を高め、コスト70%削減と現場定着を両立させました。",
      siteUrl: null,
      screenshots: [
        {
          src: './images/ai (1).png',
    ...
    },
    {
      ...
      team: "個人研究",
      duration: "継続中",
      focusPoint: "失敗からの学習によるピボット。失敗データを分析し、思考法そのものを転換して「視線のズレ」という新指標を発見した点。",
